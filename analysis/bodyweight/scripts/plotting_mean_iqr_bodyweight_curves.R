...
PLOT_DATA <- BWANIMAL_DATA %>% 
  ...
  summarise(
    N = n(),
    Mean = mean(BW_LOESS),
    p25 = quantile(BW_LOESS, probs = 0.25),
    p75 = quantile(BW_LOESS, probs = 0.75)
  ) %>% 
  ungroup() %>% 
  filter(
    N > 5
...
PLOT <- PLOT_DATA %>% 
  ...
  geom_ribbon(
    aes(x = Age, ymin = p25, ymax = p75, fill = Diet, group = Diet),
    alpha = 0.25
  ) +
  scale_x_continuous(
    breaks = seq(0,60,6),
...
pdf(
  'analysis/bodyweight/figures/summary_curves_mean_iqr/BWbyAge_Summary_Diet.pdf',
  width = 7, height = 5
)
plot(PLOT)
dev.off()
...
pdf(
  'analysis/bodyweight/figures/summary_curves_mean_iqr/BWbyPLL_Summary_Diet.pdf',
  width = 7, height = 5
)
plot(PLOT)
dev.off()
...
PLOT <- PLOT_DATA %>% 
  ...
  geom_ribbon(
    aes(x = Age, ymin = p25, ymax = p75, fill = Sex, group = Sex),
    alpha = 0.25
  ) +
  scale_x_continuous(
    breaks = seq(0,60,6),
...
pdf(
  'analysis/bodyweight/figures/summary_curves_mean_iqr/BWbyAge_Summary_Sex.pdf',
  width = 7, height = 5
)
plot(PLOT)
dev.off()
...
pdf(
  'analysis/bodyweight/figures/summary_curves_mean_iqr/BWbyPLL_Summary_Sex.pdf',
  width = 7, height = 5
)
plot(PLOT)
dev.off()
...
PLOT <- PLOT_DATA %>% 
  ...
  geom_ribbon(
    aes(x = Age, ymin = p25, ymax = p75, fill = SexDiet, group = SexDiet),
    alpha = 0.25
  ) +
  scale_x_continuous(
    breaks = seq(0,60,6),
...
pdf(
  'analysis/bodyweight/figures/summary_curves_mean_iqr/BWbyAge_Summary_SexAndDiet.pdf',
  width = 7, height = 5
)
plot(PLOT)
dev.off()
...
pdf(
  'analysis/bodyweight/figures/summary_curves_mean_iqr/BWbyPLL_Summary_SexAndDiet.pdf',
  width = 7, height = 5
)
plot(PLOT)
dev.off()
...
PLOT <- PLOT_DATA %>% 
  ...
  geom_ribbon(
    aes(x = Age, ymin = p25, ymax = p75, fill = Strain, group = Strain),
    alpha = 0.25
  ) +
  scale_x_continuous(
    breaks = seq(0,60,6),
...
pdf(
  'analysis/bodyweight/figures/summary_curves_mean_iqr/BWbyAge_Summary_Strain.pdf',
  width = 7, height = 5
)
plot(PLOT)
dev.off()
...
pdf(
  'analysis/bodyweight/figures/summary_curves_mean_iqr/BWbyPLL_Summary_Strain.pdf',
  width = 7, height = 5
)
plot(PLOT)
dev.off()
...
pdf(
  'analysis/bodyweight/figures/summary_curves_mean_iqr/BWbyAge_Summary_StrainAndDiet.pdf',
  width = 12, height = 5
)
plot(PLOT)
dev.off()
...
pdf(
  'analysis/bodyweight/figures/summary_curves_mean_iqr/BWbyPLL_Summary_StrainAndDiet.pdf',
  width = 12, height = 5
)
plot(PLOT)
dev.off()
...
pdf(
  'analysis/bodyweight/figures/summary_curves_mean_iqr/BWbyAge_Summary_StrainAndSex.pdf',
  width = 12, height = 5
)
plot(PLOT)
dev.off()
...
pdf(
  'analysis/bodyweight/figures/summary_curves_mean_iqr/BWbyPLL_Summary_StrainAndSex.pdf',
  width = 12, height = 5
)
plot(PLOT)
dev.off()
...
pdf(
  'analysis/bodyweight/figures/summary_curves_mean_iqr/BWbyAge_Summary_StrainAndSexAndDiet.pdf',
  width = 12, height = 8
)
plot(PLOT)
dev.off()
...
pdf(
  'analysis/bodyweight/figures/summary_curves_mean_iqr/BWbyPLL_Summary_StrainAndSexAndDiet.pdf',
  width = 13, height = 8
)
plot(PLOT)
dev.off()
